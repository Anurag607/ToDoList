document.addEventListener("DOMContentLoaded", () => {
    ...
    let getLists = () => {
        ...
        console.log(saved);
        if(!saved) {
            tasks.innerHTML = "<tr><th>Task No.</th><th>Day</th><th>Date</th><th>Task</th></tr>";
            savedtasks.innerHTML = "<tr><th>Task No.</th><th>Day</th><th>Date</th><th>Task</th></tr>";
        } else {
    ...
    form.onsubmit = (e) => {
        ...
        if ((tasks.childElementCount-1) > 0) {
            ...
            confirm_btn.onclick = () => {
                ...
                tasks.innerHTML = "<tr><th>Task No.</th><th>Day</th><th>Date</th><th>Task</th></tr>";
                window.localStorage.myList = "<tr><th>Task No.</th><th>Day</th><th>Date</th><th>Task</th></tr>";
